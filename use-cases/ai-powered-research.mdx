...
description: "Learn how to create market analysis, competitive intelligence, and regulatory reports using Stratosphere's AI-powered Investigations module."
---
...
Stratosphere's Investigations module uses AI to generate comprehensive research reports:
...
Stratosphere provides five core templates:
...
1. Edit directly in Stratosphere's markdown editor
...
3. Stratosphere extracts the research framework from the signal
...
Teams using Stratosphere Investigations typically see:
