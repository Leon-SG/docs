...
<Info>
Public KOL profiles are the app URLs intended for search indexing and sharing. Keep private dashboard, settings, and login URLs out of external documents and public pages.
</Info>
...
<CardGroup cols={2}>
  <Card title="KOL Engagement Workflow" icon="route" href="/use-cases/kol-engagement-workflow">
    See how public profiles fit into the broader KOL workflow.
  </Card>
  <Card title="Create a KOL Profile" icon="user-plus" href="/guides/kol/create-kol">
    Add the source profile before publishing a public page.
  </Card>
</CardGroup>
