...
<CardGroup cols={2}>
  <Card title="AI Bid Response and Compliance" icon="newspaper" href="https://medstrato.com/blog/ai-bid-response-compliance">
    Read the main-site article on semantic matching, confidence scoring, and evidence chains.
  </Card>
  <Card title="Bid Autopilot" icon="rocket" href="/guides/tenders/bid-autopilot">
    Use one click to parse, match, check compliance, and build a proposal package.
  </Card>
</CardGroup>
