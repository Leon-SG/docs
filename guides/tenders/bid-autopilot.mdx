...
<CardGroup cols={3}>
  <Card title="Main product page" icon="globe" href="https://medstrato.com/features">
    Compare Bid Autopilot with manual technical, commercial, and package workflows.
  </Card>
  <Card title="Tender & Bid Automation" icon="route" href="/use-cases/tender-bid-automation">
    See where Autopilot fits in the full RFP-to-submission process.
  </Card>
  <Card title="Case study: 4 Weeks to 4 Days" icon="chart-line" href="https://medstrato.com/blog/from-4-weeks-to-4-days">
    Read the operational case for faster tender response.
  </Card>
</CardGroup>
