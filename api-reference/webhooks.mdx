---
title: 'Webhooks'
description: 'Receive real-time notifications when events occur in Stratosphere.'
---

## Overview

Webhooks allow you to receive HTTP POST requests when specific events occur in your Stratosphere organization. Use webhooks to:
...
Stratosphere signs all webhook payloads using HMAC-SHA256. Verify signatures to ensure requests are authentic:
...
If your endpoint returns a non-2xx status code, Stratosphere will retry the webhook:
